...
public class Command_SURPencil : Rhino.Commands.Command
{
  public override string EnglishName
  {
    get { return "SURPencil"; }
  }
  ...
  protected override Rhino.Commands.Result RunCommand(Rhino.RhinoDoc doc, Rhino.Commands.RunMode mode)
  {
    ...
    if (m_compiledCode == null)
    {
      ...
      string source = rm.GetString("SURPencil");
  ...
  private string DecryptString(string text)
  {
    ...
    System.Guid key = new System.Guid("6359bd60-bf41-fd26-94e9-570205358769");
