...
public class Command_SURCircleOnSurface : Rhino.Commands.Command
{
  public override string EnglishName
  {
    get { return "SURCircleOnSurface"; }
  }
  ...
  protected override Rhino.Commands.Result RunCommand(Rhino.RhinoDoc doc, Rhino.Commands.RunMode mode)
  {
    ...
    if (m_compiledCode == null)
    {
      ...
      string source = rm.GetString("SURCircleOnSurface");
  ...
  private string DecryptString(string text)
  {
    ...
    System.Guid key = new System.Guid("575c5766-41a6-3291-cf7b-66c1bc2248b5");
