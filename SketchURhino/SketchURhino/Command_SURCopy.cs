...
public class Command_SURCopy : Rhino.Commands.Command
{
  ...
  protected override Rhino.Commands.Result RunCommand(Rhino.RhinoDoc doc, Rhino.Commands.RunMode mode)
  {
    ...
    if (m_compiledCode == null)
    {
      ...
      string source = rm.GetString("SURCopy");
  ...
  private string DecryptString(string text)
  {
    ...
    System.Guid key = new System.Guid("f5f6e0b9-3805-698c-22fc-9ff060277623");
